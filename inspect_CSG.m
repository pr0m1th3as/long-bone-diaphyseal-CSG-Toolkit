% Copyright (C) 2020-2021 Andreas Bertsatos <abertsatos@biol.uoa.gr>
%
...
% This script reads all the available "geometry-$$.csv" files present in the working folder
% to establish the number of different bones present and utilizes the 'visualize_CrossSections'
% function to plot the data for visual inspection for each individual bone's cross-sectional
% contours, while asking the user for verification. If contours are shown as a simple polygon,
% then the results are valid and the user may confirm by pressing the "yes" button in order to
% read and append the CSG properties into tabular form. If not, the particular sample is ignored
% and the inspection proceeds to the next available sample. If the user cancels, the process is
% terminated and the already appended values are saved in csv file named "Complete Data.csv".
%
...
complete(1,4) = {"angle-35_50"}; complete(1,5) = {"angle-50_65"}; complete(1,6)={"angle-65_80"};
complete(1,7) = {"diaphyseal bending"};
complete(1,8) = {"Area 20%"}; complete(1,9) = {"Perimeter 20%"}; complete(1,10) = {"Ix 20%"};
complete(1,11) = {"Iy 20%"}; complete(1,12) = {"Ixy 20%"}; complete(1,13) = {"Imin 20%"};
complete(1,14) = {"Imax 20%"}; complete(1,15) = {"Theta 20%"};
complete(1,16) = {"Area 35%"}; complete(1,17) = {"Perimeter 35%"}; complete(1,18) = {"Ix 35%"};
complete(1,19) = {"Iy 35%"}; complete(1,20) = {"Ixy 35%"}; complete(1,21) = {"Imin 35%"};
complete(1,22) = {"Imax 35%"}; complete(1,23) = {"Theta 35%"};
complete(1,24) = {"Area 50%"}; complete(1,25) = {"Perimeter 50%"}; complete(1,26) = {"Ix 50%"};
complete(1,27) = {"Iy 50%"}; complete(1,28) = {"Ixy 50%"}; complete(1,29) = {"Imin 50%"};
complete(1,30) = {"Imax 50%"}; complete(1,31) = {"Theta 50%"};
complete(1,32) = {"Area 65%"}; complete(1,33) = {"Perimeter 65%"}; complete(1,34) = {"Ix 65%"};
complete(1,35) = {"Iy 65%"}; complete(1,36) = {"Ixy 65%"}; complete(1,37) = {"Imin 65%"};
complete(1,38) = {"Imax 65%"}; complete(1,39) = {"Theta 65%"};
complete(1,40) = {"Area 80%"}; complete(1,41) = {"Perimeter 80%"}; complete(1,42) = {"Ix 80%"};
